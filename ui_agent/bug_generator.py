...
SYSTEM_PROMPT = """You are a senior UI/UX auditor. Given a website classification and its features, generate exactly 12 realistic, specific UI/UX issues that this type of website commonly has.
...
def generate_bugs(classification: dict, site_url: str, api_key: str) -> list[dict]:
    ...
    print("  Generating 12 potential UI/UX bugs with MiniMax M2.5 ...")
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": f"""Website URL: {site_url}\n\nClassification and features:\n{classification_text}\n\nGenerate exactly 12 potential UI/UX bugs for this type of website. Return ONLY the JSON array."""},
            ],
            max_tokens=8192,
            temperature=0.7,
        )
